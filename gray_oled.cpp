...
void SeeedGrayOLED::init(int fd)
{
    struct timespec tspec = {.tv_sec = 0, .tv_nsec = 200000000};
...
{
    i2c_write_register8(fd_i2c, SeeedGrayOLED_Address, SeeedGrayOLED_Command_Mode, command);
}
...
{
    i2c_write_register8(fd_i2c, SeeedGrayOLED_Address, SeeedGrayOLED_Data_Mode, Data);
}
